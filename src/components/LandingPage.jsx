    ...
    <div className="w-full h-screen bg-zinc-900 pt-1">
            ...
            {["We Create", "Eye Opening", "Presentations"].map((item, index) => {
                ...
                <div className="masker">
                    <div className="w-fit flex items-end overflow-hidden">
                        {index === 1 && (
                            <div className='mr-[1vw] w-[7vw] flex item-center rounded-md h-[5.5vw] top-[0.8vw] relative bg-green-500'></div>)}
        ...
        <div className="border-t-[1px] border-zinc-700 mt-32 flex justify-between items-center py-5 px-20">
            ...
            <div className="start flex items-center gap-5 ">
                    <div className="px-5 py-2 border-[1px] border-zinc-500 font-light text-md capitalize rounded-full">Start The Project</div>
