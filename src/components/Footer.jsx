...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-[Test_Founders_Gtsk_X-Cond_SmB] ">
        <div className="heading ">
          <h1 className="text-9xl font-semibold uppercase leading-none -mb-8">
            Eye
          </h1>
          <h1 className="text-9xl font-semibold uppercase leading-none -mb-8">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-8xl font-semibold uppercase leading-none -mb-8 font-[Test_Founders_Gtsk_X-Cond_SmB]">
          Presentaions
        </h1>
        <div className="dets font-['Neue_Montreal_Regular'] py-10 ">
          <a className=" block text-xl mt-5 " href="">
            Facebook
          </a>
          <a className=" block text-xl mt-5 " href="">
            Instagram
